...
\setmonofont[Scale=0.88]{CMU Typewriter Text}
...
та \textbf{Tamarin~Prover~1.10.0} (8/8 лем доведено за 22,83~с). Реалізацію
...
\begin{enumerate}
  ...
  \item \textbf{Повна формальна верифікація.} Сім властивостей безпеки
        ...
        (5/5) та Tamarin~1.10.0 (8/8 лем, 22,83~с).
...
Час верифікації: \textbf{22,83~секунди} (8~лем).
...
Формальні моделі & & 1790 & Tamarin, ProVerif \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{itemize}
  ...
  \item \textbf{Tamarin~Prover~1.10.0}: 8/8 лем доведено за
        22,83~с; зокрема пряма секретність (119~кроків) та
