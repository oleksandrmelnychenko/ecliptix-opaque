...
<!-- All items must be checked for PRs touching src/ or include/ -->

### Memory Safety
- [ ] All sensitive data uses `SecureBuffer` or `secure_bytes`
- [ ] All intermediate sensitive values are zeroed with `sodium_memzero()`
...
- [ ] Constant-time comparisons for secrets (`crypto_verify_*`)
...
- [ ] No sensitive data in any logging statements
...
- [ ] I have read and followed the [Secure Coding Guidelines](../docs/isms/SECURE_CODING_GUIDELINES.md)
