...
fn authenticate(
    ...
    initiator_finish(&mut client_state, &mut client_session_key, &mut client_master_key)?;

    Ok((client_session_key, client_master_key, server_session_key, server_master_key))
}
