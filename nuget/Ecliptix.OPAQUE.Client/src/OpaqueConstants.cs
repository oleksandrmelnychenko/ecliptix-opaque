...
public static class OpaqueConstants
{
    ...
    /// <summary>Registration record length in bytes.</summary>
    public const int REGISTRATION_RECORD_LENGTH = 168;

    /// <summary>Credential request message length in bytes.</summary>
    public const int CREDENTIAL_REQUEST_LENGTH = 88;
